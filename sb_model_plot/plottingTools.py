...
def makeSplusBPlot(workspace,hD,hSB,hB,hS,hDr,hBr,hSr,cat,options,dB=None,reduceRange=None,limit=None):
  ...
  #lat0.DrawLatex(0.15,0.83,"#scale[0.75]{(Spin-2) X #rightarrow HH #rightarrow #gamma#gamma#tau#tau}")
  ...
  #  lat0.DrawLatex(0.13,0.77,"#scale[0.75]{%s}"%poiStr)
    ...
    if limit is not None: lat0.DrawLatex(0.15,0.77,"#sigma #bf{#it{#Beta}} = %.3f fb}"%(limit))
